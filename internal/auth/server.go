...
// Start starts the setup server and optionally opens the browser.
func (s *SetupServer) Start(ctx context.Context, autoOpenBrowser bool) (*SetupResult, error) {
	// Generate CSRF token
...
func shouldSkipAutoBrowserOpen() bool {
	...
	for _, env := range []string{"FASTMAIL_NO_BROWSER", "NO_BROWSER"} {
